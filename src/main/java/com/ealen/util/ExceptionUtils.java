...
/**
 * <p>
 * <code>ExceptionUtils</code> provides utilities for manipulating
...
public class ExceptionUtils {
     ...
     * exception. Package private for accessibility by test suite.
     */
    ...
    /**
     * Constructs a new <code>ExceptionUtils</code>. Protected to discourage
     * instantiation.
     */
     ...
     *
     * @param methodName
     *            the methodName to add to the list, null and empty strings are
     *            ignored
     */
     ...
     * added to using {@link #addCauseMethodName(String)}. The default list
     * searched for are:
     * </p>
     * <ul>
    ...
    /**
     * <p>
     * Walks through the exception chain to the last element -- the "root" of
     * the tree -- using {@link #getCause(Throwable)}, and returns that
     * exception.
     * </p>
     *
     * @param throwable
    ...
    /**
     * <p>
     * Returns the number of <code>Throwable</code> objects in the exception
     * chain.
     * </p>
     *
     * @param throwable
    ...
    /**
     * <p>
     * Delegates to {@link #indexOfThrowable(Throwable, Class, int)}, starting
     * the search at the beginning of the exception chain.
     * </p>
     *
     ...
     * matches the specified type in the exception chain of
     * <code>Throwable</code> objects with an index greater than or equal to the
     * specified index, or <code>-1</code> if the type is not found.
     * </p>
     *
     * @param throwable
     *            the exception to inspect
     * @param type
     *            <code>Class</code> to look for
     * @param fromIndex
     *            the (zero based) index of the starting position in the chain
     *            to be searched
     * @return the first occurrence of the type in the chain, or <code>-1</code>
    ...
    /**
     * Prints a compact stack trace for the root cause of a throwable. The
     * compact stack trace starts with the root cause and prints stack frames up
     * to the place where it was caught and wrapped. Then it prints the wrapped
    ...
    /**
     * Same as printRootCauseStackTrace(t, stream), except it takes a
     * PrintWriter as an argument.
     */
    ...
    /**
     * Produces a List of stack frames - the message is not included. This works
     * in most cases - it will only fail if the exception message contains a
     * line that starts with: " at".
     *
     * @param t
     *            is any throwable
