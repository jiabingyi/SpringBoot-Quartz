...
public class AssemblyMail {
    ...
    private static final Logger logger = LoggerFactory.getLogger(AssemblyMail.class);
    ...
    public boolean createMimeMessage() {
        try {
            ...
            logger.error("获取邮件会话对象时发生错误！" + e.getMessage(), e);
            return false;
        }
        ...
        try {
            ...
            logger.error("创建MIME邮件对象失败！" + e.getMessage(), e);
            return false;
        }
    }
    ...
    public boolean setBody(String mailBody) {
        try {
            ...
            logger.error("设置邮件正文时发生错误！" + e.getMessage(), e);
            return false;
        }
    }
    ...
    public boolean addFileAffix(String filePath, String fileName) {
        ...
        try {
            ...
            logger.error("增加邮件附件：" + filePath + "发生错误！" + e.getMessage(), e);
            return false;
        }
    }
    ...
    public boolean addPicFile(Map<String, String> map) {
        try {
            ...
            logger.error("增加嵌入图片发生错误！" + e.getMessage(), e);
            return false;
        }
    }
    ...
    public static void main(String[] args) {
        ...
        AssemblyMail.sendAndCc("192.168.46.32", "san.zhang@contoso.com",
                "shirley.liu@vipshop.com;stone.zhu@vipshop.com", "", "test", "testCon", "san.zhang", "abc.1234",
