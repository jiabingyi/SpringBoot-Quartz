...
//    private Props props;
    ...
    // 邮件服务器
    public static String SMTP = "smtp.ppdaicorp.com";
    // 邮件服务器账号
    public static String ACCOUNT = "deploy@ppdai.com";
    // 邮件账号
    public static String USERNAME = "deploy";
    // 邮件密码
    public static String PASSWORD = "cndns22!";
    // 接口调用异常接收邮箱
    public static String RECEIVER = "jiayuxiang@ppdai.com";
